...
namespace MultiCart
{
  ...
  {
    public const string ModuleName = "MultiCart";

    #region · Data members ·
    private ExpansionSetupPageInfo[] m_setup_page_info;
    private TVCMultiCart m_multicart;
    #endregion
    ...
    public override void Initialize(ExpansionManager in_expansion_manager, int in_expansion_index)
    {
      ...
      Settings = ParentManager.Settings.GetSettings<MultiCartSettings>(in_expansion_index);
    }
    ...
    {
      m_multicart = new TVCMultiCart();
      m_multicart.SetSettings((MultiCartSettings)Settings);
