...
namespace CustomControls
{
	...
	/// <summary>
	/// Converts equation Values to Control.Visibility values
	/// </summary>
	[TypeConverter(typeof(IsEqualToVisibilityConverter))]
	[ValueConversion(typeof(bool), typeof(Visibility))]
	...
	/// <summary>
	/// Converts equation to Control.Visibility values
	/// </summary>
	[TypeConverter(typeof(IsNotEqualToVisibilityConverter))]
	[ValueConversion(typeof(bool), typeof(Visibility))]
	public class IsNotEqualToVisibilityConverter : IValueConverter
	{
		#region · Properties ·
		...
		#region · Singleton instance handling ·
		private static IsNotEqualToVisibilityConverter m_instance = null;

		public static IsNotEqualToVisibilityConverter Instance
		{
			get
			{
				if (m_instance == null)
					m_instance = new IsNotEqualToVisibilityConverter();
