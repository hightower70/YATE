...
namespace TVCEmuCommon.ExpansionManager
{
  ...
  /// </summary>
    ...
    /// <param name="in_form_index"></param>
		public ExpansionSetupTreeInfo(ExpansionSetupPageInfo in_settings, int in_module_index, int in_form_index)
		{
		...
		public ExpansionSetupTreeInfo(string in_display_name, ExpansionSetupPageInfo in_settings, int in_module_index, int in_form_index)
		{
